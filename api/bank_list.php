...
if($bank_id == 'all'){
    $sql = "SELECT bank_cmp_cat.id,bank_cmp_cat.cat,bank_cmp_cat.remarks,banks.bank_name FROM bank_cmp_cat,banks WHERE bank_cmp_cat.bank_name=banks.id AND bank_cmp_cat.company_name = '$company_name' LIMIT 25";
